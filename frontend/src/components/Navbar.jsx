...
import { Search, Bell, MessageSquare, Calendar, ChevronDown, AlignLeft, LogOut, CheckSquare } from 'lucide-react';
      ...
      <div className="flex items-center gap-4 flex-1 max-w-lg">
        ...
        <div className="relative w-full">
          <input
            ...
            className="w-full h-10 pl-4 pr-10 rounded-full bg-[#F5F7FB] border-none text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#4F46E5]/20 focus:bg-white transition-all"
          />
        ...
        {currentUser && (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 hover:bg-gray-50 p-1 rounded-xl transition-all"
            >
              <img
